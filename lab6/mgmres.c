...
/*
  Purpose:
    ...
    DIAGONAL_POINTER_CR finds diagonal entries in a sparse compressed row
  matrix.
...
void mgmres_st(int n, int nz_num, int ia[], int ja[], double a[], double x[],
               double rhs[], int itr_max, int mr, double tol_abs,
               double tol_rel)
...
/*
  Purpose:
    ...
    R8VEC_UNIFORM_01 fills a double precision vector with unit pseudorandom
  values.
